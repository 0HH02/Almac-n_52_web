...
function orido_tm_service_popup(){
	...
	button.on('click',function(){
		...
		if(elImage == 'assets/img/service/1.jpg'){
			modalBox.find('.service_popup_informations').prepend('<div class="image image_container1"><img src="assets/img/thumbs/4-2.jpg" alt="" /><div class="main secundary_image" data-img-url="'+elImage+'"></div></div>');
		}
		else if(elImage == 'assets/img/service/2.jpg'){
			modalBox.find('.service_popup_informations').prepend('<div class="image image_container2 vertical_image"><img src="assets/img/thumbs/4-2.jpg" alt="" /><div class="main secundary_image" data-img-url="'+elImage+'"></div></div>');
		}else if(elImage == 'assets/img/service/3.jpg'){
			modalBox.find('.service_popup_informations').prepend('<div class="image image_container3 vertical_image"><img src="assets/img/thumbs/4-2.jpg" alt="" /><div class="main secundary_image" data-img-url="'+elImage+'"></div></div>');
		}else if(elImage == 'assets/img/service/4.jpg'){
			modalBox.find('.service_popup_informations').prepend('<div class="image image_container4 vertical_image"><img src="assets/img/thumbs/4-2.jpg" alt="" /><div class="main secundary_image" data-img-url="'+elImage+'"></div></div>');
		}else if(elImage == 'assets/img/service/5.jpg'){
			modalBox.find('.service_popup_informations').prepend('<div class="image image_container5"><img src="assets/img/thumbs/4-2.jpg" alt="" /><div class="main secundary_image" data-img-url="'+elImage+'"></div></div>');
		}
		orido_tm_data_images();
...
function orido_tm_nav_bg(){
	...
	jQuery(window).on('scroll',function(){
		...
		var karitex 		= jQuery('.details .short .font-medium');
		
		if(WinOffset >= 10){
			progress.addClass('animate');
			karitex.removeClass('z-index-10');
		}else{
			karitex.addClass('z-index-10');
